...
import gobject, gtk
from gtk import gdk
from FormEditorChild import FormEditorChild
...
class FormEditor(gtk.Container):
    """
    ...
    def _pick_child(self, window_x, window_y):
        ...
        reversed.reverse()
        for c in reversed:
            if c.in_drag_area(window_x, window_y):
                return c
        return None
...
if gtk.pygtk_version >= (2, 8):
    FormEditor.set_set_scroll_adjustments_signal('set-scroll-adjustments')

gobject.type_register(FormEditor)
